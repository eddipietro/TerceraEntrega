...
const { signupRouter } = require("./src/routes/userRouter");
const { logoutRouter } = require("./src/routes/userRouter");
const { profileRouter } = require("./src/routes/userRouter");
const generalViewsRouter = require("./src/routes/generalViewsRouter");
const ordenesRouter = require("./src/routes/ordenesRouter");
